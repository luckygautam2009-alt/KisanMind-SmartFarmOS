          ...
          <div className="grid grid-cols-1 md:grid-cols-12 auto-rows-[minmax(300px,auto)] gap-6">
            ...
            >
              ...
              <div className="w-full md:w-2/5 relative min-h-[250px] overflow-hidden">
                <img src="https://plus.unsplash.com/premium_photo-1661963493749-076953e0813b?q=80&w=2344&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="crop image" className="absolute inset-0 w-full h-full object-cover opacity-60 group-hover:opacity-80 transition-opacity group-hover:scale-105 duration-700" />
